	...
	<section class="row mt-3">
		<div class="card w-100 m-auto">
			...
			<div class="card-body w-100 bg-success">
				<form action="?controller=student&method=update" method="POST" class="needs-validation" novalidate>
					...
					<div class="form-group row">
						<div class="col-4">
							...
							<select name="id_tipo_id" class="form-control" required>
								<option value="">Seleccione de nuevo...</option>
