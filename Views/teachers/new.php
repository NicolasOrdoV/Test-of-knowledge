<main class="container header">
	<div class="row">
		<h1 class="col-12 d-flex justify-content-center">Nuevo Profesor</h1>
	</div>
	<section class="row mt-3">
		<div class="card w-100 m-auto">
			<div class="card-header container bg-dark">
				<h2 class="m-auto">Informacion del profesor</h2>
			</div>
				...
				<form action="?controller=teacher&method=save" method="POST" class="needs-validation" novalidate>
					...
					<div class="form-group row">
						<div class="col-6">
							...
							<input type="number" name="nomina" class="form-control" placeholder="&#36;Salario mensual*" required>
							<div class="invalid-feedback">Por favor no dejes el campo vacio</div>
							<div class="valid-feedback">Campo valido</div>
						</div>
						<div class="col-6">
